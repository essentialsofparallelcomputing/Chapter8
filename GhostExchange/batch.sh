...
for (( j=0; j<11; ++j)); do
   ...
   do
      cd $i
      mpirun -n 144 --bind-to hwthread --mca btl_base_warn_component_unused 0 ./GhostExchange -x 12 -y 12 -i 20000 -j 20000 -h 2 -t -c
      cd ..
   done
   ...
   do
      cd $i
      mpirun -n 144 --bind-to hwthread --mca btl_base_warn_component_unused 0 ./CartExchange -x 12 -y 12 -i 20000 -j 20000 -h 2 -t -c
      cd ..
   done
