...
int main(int argc, char *argv[])
{
    ...
    */
   haloupdate_test(cart_comm, nhalo, corners, jsize, isize, nleft, nrght, nbot, ntop, jmax, imax, nprocy, nprocx, cart_col, cart_row, do_timing);
   ...
   if (rank == 0){
      printf("CartExchange_VectorType Timing is stencil %f boundary condition %f ghost cell %lf total %f\n",
